//https://www.youtube.com/watch?v=kPSBpfUpHt0&t=4s
#include <Servo.h>
Servo Myservo;
...
void loop()
{
  ...
  delay(10);
  if (distance > 70)               // Condition For Absence Of Obstacle
  {
    Myservo.write(90);
  ...
  else if ((distance < 50)&&(distance > 0))            // Condition For Presence Of Obstacle
  {
